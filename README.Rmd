...
Note that this branch works with the "old" CRAN version of `ggplot2` (1.0.1). If you are using `ggplot2` fresh from CRAN (version 2 or higher) see the `master` branch of this repository.
